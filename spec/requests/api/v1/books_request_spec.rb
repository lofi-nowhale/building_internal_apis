...
describe "Books API" do 
  ...
  it "can get one book by its id" do #this is for a show page
    id = create(:book).id #calling the book model
  ...
  it "can create a new book" do 
    ...
    headers = {"CONTENT_TYPE" => "application/json"} #header is included to make sure that the headers are passed as JSON rather than plan text
  ...
  it "can update an existing boook" do 
    id = create(:book).id
